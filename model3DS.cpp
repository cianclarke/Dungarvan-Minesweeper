...
void material3DS::loadTexture(std::string filename, int chunkType){
	...
	if((filename.find(".tga") == std::string::npos) && (filename.find(".bmp") == std::string::npos)&& (filename.find(".png") == std::string::npos) &&  (filename.find(".jpg") == std::string::npos)){
	...
	if(filename.find(".tga") != std::string::npos){
		...
		int extension = filename.find(".png");
		filename.replace(extension, extension+4, ".bmp");
		printf("importing png %s", filename);

		textureBMP	 newTexture(filename, newTextureId);
	}
	else if (filename.find(".jpg") != std::string::npos){
		int extension = filename.find(".jpg");
		filename.replace(extension, extension+4, ".bmp");
		printf("importing jpg %s", filename);
